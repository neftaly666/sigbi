...
Tarda unos segundos, **renombra el archivo** a *SIGBI Sistema de Gestión Bibliotecaria
Inteligente* y lo deja con cuatro páginas:
...
| `SIGBI Responsive` | `book-mobile` - 390 x 844 con navegación inferior |
