...
| Código del documento | EST010 |
| Versión | 1.1 |
| Fecha | 2026-09-11 |
| Autor | Dante Willy Quispe Madueño |
| Estado | Vigente |
| Motor | PostgreSQL 15+ |
| Ámbito | Toda entidad JPA de `backend/src/main/java/com/sigbi/model` |

## Control de versiones

| Versión | Fecha | Autor | Descripción del cambio |
|---|---|---|---|
| 1.0 | 2026-09-09 | D. Quispe | Versión inicial, derivada del backend existente. |
| 1.1 | 2026-09-11 | D. Quispe | Incorporación a la línea documental AN/EST: portada, control de versiones y referencias cruzadas. |
...
> (`backend/src/main/java/com/sigbi/model/` y `application.yaml`). Toda entidad nueva
...
> ### Aviso: Por qué el nombre de la PK no es negociable
>
...
con `Patient` del código base; el rótulo en pantalla dice "Documento".
...
- [`EST020-estándar-de-backend-java.md`](EST020-estándar-de-backend-java.md) - norma de código del backend.
- [`AN070-esquema-del-backend.md`](AN070-esquema-del-backend.md) - esquema resultante de aplicar este estándar.
