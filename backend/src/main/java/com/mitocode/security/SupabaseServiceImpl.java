...
//Unico punto del backend que habla con Supabase Auth. Aqui viven las contrasenas, no en user_data
@Slf4j
@Service
public class SupabaseServiceImpl implements ISupabaseService {
    ...
    //Clave publica: solo sirve para pedir el token con email y password
    ...
    public SupabaseUser createAuthUser(String email, String password, String username) {
        try {
            //email_confirm deja al usuario activo sin pasar por el correo de confirmacion
            return restClient.post()
